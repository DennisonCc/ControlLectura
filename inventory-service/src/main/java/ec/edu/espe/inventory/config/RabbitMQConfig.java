package ec.edu.espe.inventory.config;
...
public class RabbitMQConfig {
    ...
    public Queue inventoryOrdersQueue() {
        return QueueBuilder.durable(INVENTORY_ORDERS_QUEUE)
                .build();
    }

    @Bean
    public Queue ordersResultsQueue() {
        return QueueBuilder.durable(ORDERS_RESULTS_QUEUE)
                .build();
    }

    @Bean
    public Binding inventoryOrdersBinding(Queue inventoryOrdersQueue, TopicExchange ordersExchange) {
    ...
    @Bean
    public Binding stockReservedBinding(Queue ordersResultsQueue, TopicExchange ordersExchange) {
    ...
    @Bean
    public Binding stockRejectedBinding(Queue ordersResultsQueue, TopicExchange ordersExchange) {
        return BindingBuilder.bind(ordersResultsQueue)
                .to(ordersExchange)
